        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('uploads/product/large/39-33-1716241190.jpg')}}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('uploads/product/large/39-33-1716241190.jpg')}}" />
                        <img src="{{ asset('uploads/product/large/39-33-1716241190.jpg')}}" alt="" />
                    </picture>
